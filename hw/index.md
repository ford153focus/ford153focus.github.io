...
Part/Device Name | Value | Specs | Comment
---------------- | ----- | ----- | -------
Case | Chieftec DX01
Case | Exegate 4139L | 4U server case
Cooling | Tt Contact 30 | tower type, 120mm
Cooling | Zalman CNPS10X Performa | tower type, 120mm | Default cooler is bit noisy
...
Keyboard | Mitsumi KFK-EA4XT | PS/2
...
#home-pc ~ table th:nth-child(1) {
    min-width: 120px;
}
#home-pc ~ table th:nth-child(2) {
    min-width: 350px;
}
#home-pc ~ table th:nth-child(3) {
    min-width: 300px;
}
